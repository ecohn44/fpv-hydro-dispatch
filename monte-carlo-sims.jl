...
mapes = [0, 0.05, 0.1, 0.15, 0.2] # noise parameter
...
## Run Simulation with preset price of water and noisy input data
# for i = 1,..., n = 100 (number of simulations)
...
sigma_mae = col_symbol in propertynames(sigmas) ? sigmas[:, col_symbol] : nothing
